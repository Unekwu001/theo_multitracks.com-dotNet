										...
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												<img class="song-list--item--player-img--img" 
													srcset="./PageToSync/img/2822.jpg 2x" 
											...
											<div class="song-list--item--right">
												...
												<a class="song-list--item--secondary">BPM</a>
												<a class="song-list--item--secondary">Rating</a>
								   ...
								   <ItemTemplate>
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--right">
												...
												<a class="song-list--item--secondary"><%# Eval("albTitle") %></a>
												<a class="song-list--item--secondary"><%# Eval("sgBpm") %> BPM</a>
